            ...
            while tank.has_message():
                ...
                if msg.startswith(ArduinoConstants.MESSAGE_PREFIX_LOG):
                    ...
                    print('\n'.join([
                        ...
                        f"{lidarMap.get_closest_available_angle(90.0):>5} : {lidarMap.get_measurement(lidarMap.get_closest_available_angle(90.0),0.1):<6}",
                        f"{lidarMap.get_closest_available_angle(180.0):>5} : {lidarMap.get_measurement(lidarMap.get_closest_available_angle(180.0),0.1):<6}",
                        f"{lidarMap.get_closest_available_angle(270.0):>5} : {lidarMap.get_measurement(lidarMap.get_closest_available_angle(270.0),0.1):<6}"
                    ]))
